...
if show_cycle_length:
    ...
    if 'Date' in df.columns and len(df['Date'].unique()) > 1:
        ...
        # Single day data - proceed with analysis
        ...
        def create_cycle_table(vol_col_name, direction_name, data_df):
            ...
            if not table_df:
                st.warning(f"⚠️ No data found for {direction_name} in the selected time period.")
                return []
        ...
        # Show time period and direction specific info
        period_info = {
